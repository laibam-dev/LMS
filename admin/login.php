...
// 1. Auth Check using BASE_URL (Constants config/db.php mein honi chahiye)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['profile_pic']['name'])) {
        ...
        if (move_uploaded_file($_FILES['profile_pic']['tmp_name'], $target_file)) {
            // IMPORTANT: DB mein sirf folder name se path save karein (no ../)
