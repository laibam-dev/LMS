...
<div class="d-flex">
    ...
    <div class="flex-grow-1" style="margin-left:220px; padding:2rem 2rem 2rem 2rem;">
    <div class="row mb-4">
        <div class="col">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card shadow-sm border-0 p-4" style="background-color:#003366; color:#FFD700;">
                <h4 class="fw-bold mb-4" style="color:#FFD700;">Visual Analytics</h4>
                <div class="row">
    ...
    <div class="col-md-3">
        <div class="card stat-card shadow-sm h-100 border-start border-info border-5">
            <div class="card-body text-center p-4">
                <h5 class="text-muted mb-3">Total Enrollments</h5>
                <h2 class="display-5 fw-bold text-info"><?php echo $enroll_data['total']; ?></h2>
            </div>
        </div>
    </div>
